  ...
  function check() {
    // We get the hit circles and lines' properties from HTML
    ...
    // JavaScript objects for the circles
    ...
    // JavaScript objects for the lines
    ...
    // Gets the distance between the upper hit circle and the lines
    ...
    // Gets the distance between the lower hit circle and the lines
    ...
    // If any of the distances are less than distance of the circle's radius and the width of the line (meaning the circle and line overlap), we return a Boolean of true. Otherwise, we return false
...
// A handy formula from StackOverflow for finding the distance between a circle and line. See README for credits
